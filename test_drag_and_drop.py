...
def test_drag_and_drop():
    ...
    try:
        ...
        print(f"✅ DropHighlightDelegate active: {manager.drop_highlight_delegate is not None}")
        print(f"✅ Highlighted drop index initialized: {not manager.highlighted_drop_index.isValid()}")
        ...
        if has_file_ops:
            has_handle_drop = hasattr(parent.file_operations_ui, 'handle_drop_on_folder')
