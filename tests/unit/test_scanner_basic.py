...
class TestScannerBasic(unittest.TestCase):
    ...
    def create_test_files(self):
        ...
        for file_path in [
            ...
            self.file2_archive, self.file2_preview,
            self.file3_archive, self.file4_preview
        ]:
    ...
    def test_collect_files_basic(self):
        ...
        # W nowej implementacji mamy 3 unikalne nazwy bazowe: file1, file2, file3/file4
    ...
    def test_collect_files_max_depth(self):
        ...
        self.assertEqual(len(file_map), 3)  # Wszystkie pliki
    ...
    def test_create_file_pairs_basic(self):
        ...
        # Sprawdzamy pary - dwie pary: file1 i file2
        self.assertEqual(len(pairs), 2)
        self.assertEqual(len(processed), 4)  # 4 pliki zostały sparowane
        
        # Sprawdzamy czy pliki file1 są w pierwszej parze
        self.assertTrue(any(p.archive_path == self.file1_archive and p.preview_path == self.file1_preview for p in pairs))
    ...
    def test_create_file_pairs_not_all(self):
        ...
        # Powinny być maksymalnie 2 pary (jedna dla każdej unikalnej nazwy z parą)
        self.assertEqual(len(pairs), 2)
    ...
    def test_identify_unpaired_files(self):
        ...
        processed = {self.file1_archive, self.file1_preview, self.file2_archive, self.file2_preview}
    ...
    def test_is_cache_valid(self):
        ...
        time.sleep(0.1)  # Upewniamy się, że timestamp będzie nowszy
    ...
    def test_scan_folder_for_pairs_max_depth(self):
        ...
        pairs, unpaired_archives, unpaired_previews = scan_folder_for_pairs(self.test_dir, max_depth=0)
    ...
    def test_scan_folder_for_pairs_cache(self):
        ...
        start_time = time.time()
        pairs3, unpaired3_a, unpaired3_p = scan_folder_for_pairs(self.test_dir, use_cache=False)
