...
class TestScannerAdvanced(unittest.TestCase):
    ...
    def create_test_files(self):
        ...
        all_files = [
            self.file_unicode_archive,
            self.file_unicode_preview,
            self.file_case1,
            self.file_case2,
            self.file_multi1_arch1,
            self.file_multi1_arch2,
            self.file_multi1_prev1,
            self.file_multi1_prev2,
            self.file_deep_archive,
            self.file_deep_preview,
            self.file_parallel_archive,
            self.file_parallel_preview,
        ]
    ...
    def test_unicode_file_names(self):
        ...
        unicode_pair = next(
            (p for p in pairs if p.archive_path == self.file_unicode_archive), None
        )
    ...
    def test_case_insensitive_pairing(self):
        ...
        case_pair = next((p for p in pairs if p.archive_path == self.file_case1), None)
