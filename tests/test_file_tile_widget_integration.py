...
class TestFileTileWidgetIntegration:
    ...
    def test_component_integration(self, app, file_pair):
        ...
        assert (
            widget._metadata_component.get_metadata_snapshot().file_pair_id is not None
        )
    ...
    def test_thumbnail_component_integration(self, app, file_pair):
        ...
        # Test czy sygnały istnieją (nie sprawdzamy receivers w PyQt6)
        thumbnail_component = widget._thumbnail_component
        assert hasattr(thumbnail_component, "thumbnail_loaded")
        assert hasattr(thumbnail_component, "thumbnail_error")
    ...
    def test_interaction_component_integration(self, app, file_pair):
        ...
        # Test czy widget ma event filter (sprawdzamy czy jest ustawiony)
        assert hasattr(widget, "eventFilter")
        assert callable(widget.eventFilter)
