...
class BulkOperationsManager:
    ...
    def on_bulk_delete_finished(self, deleted_pairs):
        ...
        original_selected_count = len(self.main_window.controller.selected_tiles)
        ...
        for file_pair in deleted_pairs:
            ...
            if file_pair in self.main_window.controller.selected_tiles:
                self.main_window.controller.selected_tiles.remove(file_pair)
