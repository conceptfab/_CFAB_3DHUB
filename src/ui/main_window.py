...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.default_thumbnail_size = (150, 150)  # Domyślny rozmiar miniatury (px)
        self.min_thumbnail_size = (50, 50)  # Minimalny rozmiar miniatury (px)
        self.max_thumbnail_size = (300, 300)  # Maksymalny rozmiar miniatury (px)
        self.current_thumbnail_size = self.default_thumbnail_size  # Aktualny rozmiar
