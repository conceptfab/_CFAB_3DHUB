...
class GalleryManager:
    ...
    def update_gallery_view(self):
        ...
        Zoptymalizowana wersja - inkrementalne aktualizacje zamiast pełnej przebudowy.
        """
        ...
        try:
            ...
            if layout_needs_rebuild:
                ...
                # Dodaj widoczne kafelki do layoutu
                row, col = 0, 0
                for file_pair in self.file_pairs_list:
                    ...
                    if tile:
                        # Aktualizuj widoczność istniejącego kafelka
                        ...
                        # Utwórz nowy kafelek na żądanie
                        tile = self.create_tile_widget_for_pair(
                        ...
                        if tile:
                            ...
                            logging.warning(
                                f"Nie udało się utworzyć widgetu kafelka dla "
                                f"{file_pair.get_archive_path()}"
                            )
        finally:
