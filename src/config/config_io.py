...
class ConfigIO:
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Specjalna logika dla aktualizacji list rozszerzeń
            # Sprawdź czy użytkownik ma wszystkie domyślne rozszerzenia
            if "supported_archive_extensions" in config and "supported_archive_extensions" in default_config:
                ...
                if missing_extensions:
                    ...
                    updated = True
                    logger.info(f"Dodano nowe rozszerzenia archiwów: {list(missing_extensions)}")
            ...
            if "supported_preview_extensions" in config and "supported_preview_extensions" in default_config:
                ...
                if missing_extensions:
                    ...
                    updated = True
                    logger.info(f"Dodano nowe rozszerzenia podglądów: {list(missing_extensions)}")
